...
export default function LoginPage() {
    ...
    return (
      <div className="text-center">
        <div className="mx-auto mb-8 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-b from-sidebar-solid to-sidebar-solid shadow-glass-md">
          <Mail className="h-8 w-8 text-sidebar-text" />
        </div>
  ...
  return (
    <div className="text-center">
      ...
      {error && (
        <div className="mb-4 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-body-sm text-red-700">
          {error}
        </div>
      )}
        ...
        <form onSubmit={handlePasswordLogin} className="space-y-4">
          ...
          <div className="relative">
            <input
              ...
              required
              className="w-full rounded-xl border border-border-solid bg-white/60 px-4 py-3 pr-12 text-body-sm placeholder:text-text-secondary focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all"
            />
            <button
              type="button"
