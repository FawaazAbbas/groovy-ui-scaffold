  ...
  return (
    <div className="text-center">
      ...
      <div className="space-y-4">
        <div>
          <input
            ...
            className="w-full rounded-xl border border-border-solid bg-white/60 px-4 py-3 text-body-sm placeholder:text-text-secondary focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all"
          />
        </div>
        <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 text-body-sm font-medium text-white hover:bg-primary-hover transition-colors shadow-glass-sm">
      ...
      <div className="space-y-3">
        <button className="flex w-full items-center justify-center gap-2 rounded-xl border border-border-solid bg-white/50 py-3 text-body-sm font-medium text-text-primary hover:bg-white/80 transition-all duration-200">
