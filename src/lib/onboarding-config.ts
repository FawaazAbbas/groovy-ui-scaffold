...
const externalOSTourSteps: TourStep[] = [
  {
    ...
    description: 'Browse AI agents by role. Find the right employee for every task.',
    position: 'right',
    page: '/chats',
  },
  {
...
const groovySpaceTourSteps: TourStep[] = [
  {
    ...
    description: 'Connect tools and services to your workspace here.',
    position: 'bottom',
    page: '/integrations',
  },
  {
  ...
  },
  {
    ...
    description: 'Find more specialist agents to grow your AI team.',
    position: 'right',
    page: '/tasks',
  },
  {
