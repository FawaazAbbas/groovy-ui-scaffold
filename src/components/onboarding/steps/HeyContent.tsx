    ...
    <div className="text-center">
      <AnimatedEntry delay={0}>
        <div className="mb-8 sm:mb-10 flex justify-center">
          <GroovyLogo className="text-primary" style={{ fontSize: 'clamp(4em, 10vw, 6em)' }} />
        </div>
      </AnimatedEntry>

      <AnimatedEntry delay={150}>
        <h1 className="text-[clamp(32px,7vw,72px)] font-bold leading-[1.05] tracking-[-0.03em] text-text-primary">
          Welcome to Groovy.
        </h1>
      </AnimatedEntry>

      <AnimatedEntry delay={300}>
        <p className="mt-3 sm:mt-4 text-base sm:text-[20px] leading-[1.6] text-text-secondary">
